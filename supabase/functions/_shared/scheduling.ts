// NOTE: This file is duplicated from mcp/src/scheduling.ts so the edge function
// runtime (Deno) can import it. Keep in sync. If they drift, fix here first
// then back-port to mcp/src/scheduling.ts (or vice versa).

import { occursOn, type RecurrenceRule } from './practices.ts'
