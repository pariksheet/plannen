...
- Drives a rented Polestar 2 (full electric)
- Will receive an EVCO X9 at end of May 2026
- Comfortable EV range ~200km; risk-averse about charging on highways with kids
- Milo's school day ends Wednesday at 12:00
- Lina attends a creche
...
- Mara (wife) has a friend in Berlin
- Milo wants to try tobogganing
...
The secondary issue is the **one-fact-per-turn cap**. Several real turns reveal multiple durable facts at once (e.g. *"school ends Wed 12pm and I pick Lina from creche at 12pm"*). The cap silently drops the runners-up.
...
- ✅ **Save:** stable attributes ("drives a Polestar 2"), schedules ("Milo's school day ends Wednesday 12:00"), preferences ("prefers apartments over hotels", "won't risk highways with kids below 200km charge"), relationships ("Mara has a friend in Berlin"), characteristics ("Milo wants to try tobogganing").
...
- If the user says something that contradicts a known fact, call `correct_profile_fact` silently. Only surface the correction if it is significant (e.g. "I've updated Milo's school from Linde to Sint-Jozef").
...
- Family routines: "drop Milo at Linde", "Lina at creche until 12pm"
- Preferences and dislikes: "I prefer mornings", "pool not required when traveling for activities"
- Possessions and resources: "I have an electric car", "rented Polestar 2"
- Recurring locations: "our usual spot", "pool in Bosbeek"
- Interests and characteristics: "Milo is really into football lately"
- Relationships: "Mara's friend lives in Berlin"
```
