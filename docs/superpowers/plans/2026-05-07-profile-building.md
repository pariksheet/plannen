...
- When the user mentions a family member's school, activity, or routine ("drop Milo at Linde"), a personal preference ("I prefer mornings"), a recurring location, or a characteristic ("Milo is really into football lately"), treat it as a candidate fact.
