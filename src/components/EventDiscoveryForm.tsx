...
interface EventDiscoveryFormProps {
  onEventCreated?: () => void
  onStartCreateWithData?: (data: EventFormData) => void
}

export const EventDiscoveryForm = forwardRef<EventDiscoveryFormHandle, EventDiscoveryFormProps>(function EventDiscoveryForm(
