...
export function InviteJoin() {
  ...
  useEffect(() => {
    // Tier 0 is single-user — invite-link redemption needs a Tier 1+ backend
    // that doesn't exist here. Bounce to the dashboard rather than render the
    // misleading "Invalid or expired link" page.
    if (isTierZero()) {
