...
# ── 2. Run plannen init --mode=cloud_sb (Tier 2) ──────────────────────────────
step "2. plannen init --mode=cloud_sb"
npx plannen init --mode=cloud_sb --non-interactive \
...
step "6. Rollback: plannen init --mode=local_sb"
npx plannen init --mode=local_sb --non-interactive
